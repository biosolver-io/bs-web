...
// empty-module:~/form-action.server
var require_form_action = __commonJS({
  "empty-module:~/form-action.server"(exports, module) {
    module.exports = {};
  }
});
...
// node_modules/domain-functions/esm/errors.js
function isErrorWithMessage(error) {
  return typeof error === "object" && error !== null && "message" in error && typeof error.message === "string";
}
function toErrorWithMessage(maybeError) {
  const message = isErrorWithMessage(maybeError) ? maybeError.message : String(maybeError);
  return {
    message,
...
var InputErrors = class extends Error {
  constructor(errors) {
...
// node_modules/domain-functions/esm/utils.js
...
// node_modules/domain-functions/esm/constructor.js
      ...
      try {
        ...
        if (error instanceof InputErrors) {
          return {
            ...
            errors: [],
            environmentErrors: [],
            inputErrors: error.errors.map((e2) => schemaError(e2.message, e2.path))
          };
        }
...
// node_modules/domain-functions/esm/input-resolvers.js
var qsModule = __toESM(require_lib(), 1);

// app/routes/profile.education.tsx
var import_form_action = __toESM(require_form_action());

// node_modules/remix-forms/dist/index.mjs
...
function objectFromSchema(schema2) {
  return "shape" in schema2 ? schema2 : objectFromSchema(schema2._def.schema);
}
...
var makeSelectOption = ({ name, value }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value, children: name }, String(value));
...
function createSmartInput({
  ...
  return ({
    ...
    const makeRadioOption = (props2, checkedValue) => ({ name: name2, value: value2 }) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioWrapper, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { htmlFor: String(propsWithUniqueId == null ? void 0 : propsWithUniqueId.id), children: name2 })
    ...
    return fieldType === "boolean" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      Checkbox,
      {
        type: "checkbox",
        placeholder,
    ...
    ) : options && !radio ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Select, { defaultValue: value, ...commonProps, ...a11yProps, children: makeOptionComponents(makeSelectOption, options) }) : options && radio ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: makeOptionComponents(makeRadioOption(commonProps, value), options) }) : multiline ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      Multiline,
      {
        placeholder,
        defaultValue: value,
...
function createField({
  ...
  return React2.forwardRef(
    ({
      ...
      const errorsChildren = (errors == null ? void 0 : errors.length) ? errors.map((error) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Error2, { children: error }, error)) : void 0;
      ...
      if (childrenFn) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FieldContext.Provider, { value: field, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { hidden, style, ...props, children: fixRadioLabels(children) }) });
      }
      const smartInput = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        SmartInput,
        {
          fieldType,
          type,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FieldContext.Provider, { value: field, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, { hidden, style, ...props, children: [
        fieldType === "boolean" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CheckboxWrapper, { children: [
          smartInput,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { id: labelId, htmlFor: String(name), children: label })
        ] }) : radio ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { id: labelId, children: label }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroup, { ...a11yProps, children: smartInput })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { id: labelId, htmlFor: String(name), children: label }),
          smartInput
        ] }),
        Boolean(errorsChildren) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Errors, { role: "alert", id: errorsId, children: errorsChildren })
      ] }) });
    }
  );
}
function defaultRenderField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Field, { name, ...props }, String(name));
}
...
function createForm({
  ...
  useSubmit: useSubmit2,
  useActionData: useActionData2
}) {
  return function Form3({
    component = DefaultComponent,
    fetcher,
    mode = "onSubmit",
    ...
    var _a, _b, _c;
    const Component = (_a = fetcher == null ? void 0 : fetcher.Form) != null ? _a : component;
    const navigationSubmit = useSubmit2();
    const submit = (_b = fetcher == null ? void 0 : fetcher.submit) != null ? _b : navigationSubmit;
    const navigationTransition = useNavigation2();
    const transition = fetcher != null ? fetcher : navigationTransition;
    const navigationActionData = useActionData2();
    const unparsedActionData = (_c = fetcher == null ? void 0 : fetcher.data) != null ? _c : navigationActionData;
    ...
    const schemaShape = objectFromSchema(schema2).shape;
    const defaultValues = mapObject(schemaShape, (key, fieldShape) => {
      var _a2, _b2;
      const shape = shapeInfo(fieldShape);
      const defaultValue = coerceToForm(
        (_b2 = values[key]) != null ? _b2 : (_a2 = shape == null ? void 0 : shape.getDefaultValue) == null ? void 0 : _a2.call(shape),
        shape
      );
    ...
    const { errors: formErrors, isValid: isValid2 } = formState;
    ...
    const doSubmit = () => {
      var _a2;
      (_a2 = formRef.current) == null ? void 0 : _a2.dispatchEvent(
    ...
    const buttonLabel = transition.state !== "idle" ? pendingButtonLabel != null ? pendingButtonLabel : rawButtonLabel : rawButtonLabel;
    ...
    const customChildren = mapChildren(
      ...
      (child) => {
        ...
        if (child.type === Field) {
          ...
          const autoFocus = firstErroredField() ? field == null ? void 0 : field.autoFocus : (_a2 = child.props.autoFocus) != null ? _a2 : field == null ? void 0 : field.autoFocus;
          ...
          return React3.cloneElement(child, {
            role: "alert",
            children: globalErrorsState.map((error) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Error2, { children: error }, error)),
            ...child.props
          });
        } else if (child.type === Button) {
          const onClick = ["button", "reset"].includes(child.props.type) ? void 0 : onSubmit;
          return React3.cloneElement(child, {
            disabled,
    ...
    const defaultChildren = () => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      Object.keys(schemaShape).map(makeField).map((field) => renderField({ Field, ...field })),
      (globalErrorsState == null ? void 0 : globalErrorsState.length) && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Errors, { role: "alert", children: globalErrorsState.map((error) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Error2, { children: error }, error)) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { disabled, children: buttonLabel })
    ] });
    React3.useEffect(() => {
      const submitting = transition.state !== "idle";
      const shouldDisable = mode === "onChange" || mode === "all" ? submitting || !isValid2 : submitting;
      setDisabled(shouldDisable);
    }, [transition.state, formState, mode, isValid2]);
    React3.useEffect(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FormProvider, { ...form, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      Component,
      {
        ref: formRef,
        method,
...
// app/form.ts
var Form2 = createForm({ component: Form, useNavigation, useSubmit, useActionData });
...
var mutation = makeDomainFunction(schema)(async (values) => console.log(values));
var profile_education_default = () => {
  const accomplishmentTitleRef = (0, import_react2.useRef)(null);
  const accomplishmentTypeRef = (0, import_react2.useRef)(null);
  const accomplishmentCertificateRef = (0, import_react2.useRef)(null);
  const accomplishmentLinkRef = (0, import_react2.useRef)(null);
  const accomplishmentIdRef = (0, import_react2.useRef)(null);
  const accomplishmentPublisherRef = (0, import_react2.useRef)(null);
  const accomplishmentNameRef = (0, import_react2.useRef)(null);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form2, { schema, values: { accomplishments: [] }, children: ({ Field, Errors, Button, watch, setValue }) => {
    const accomplishments = watch("accomplishments");
    return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Field, { name: "type", label: "First name" }, void 0, false, {
        fileName: "app/routes/profile.education.tsx",
        lineNumber: 57,
        columnNumber: 15
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Field, { name: "field", children: ({ Label, SmartInput, Errors: Errors2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Label, { children: "E-mail" }, void 0, false, {
          fileName: "app/routes/profile.education.tsx",
          lineNumber: 61,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("em", { children: "You'll hear from us at this address \u{1F447}\u{1F3FD}" }, void 0, false, {
          fileName: "app/routes/profile.education.tsx",
          lineNumber: 62,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(SmartInput, {}, void 0, false, {
          fileName: "app/routes/profile.education.tsx",
          lineNumber: 63,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Errors2, {}, void 0, false, {
          fileName: "app/routes/profile.education.tsx",
          lineNumber: 64,
          columnNumber: 21
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Field, { name: "country", type: "select", options: countries_default.map((country) => {
        return {
          label: country.name,
          name: country.name,
          value: country.code
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Field, { name: "university" }, void 0, false, {
        fileName: "app/routes/profile.education.tsx",
        lineNumber: 75,
        columnNumber: 15
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Field, { name: "accomplishments", children: ({ Label, Errors: Errors2 }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Label, {}, void 0, false, {
          fileName: "app/routes/profile.education.tsx",
          lineNumber: 79,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("fieldset", { className: "gap-2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
            "button",
            {
              ...
              onClick: (event) => {
                ...
                const name = (_a = accomplishmentNameRef.current) == null ? void 0 : _a.value;
                const type = (_b = accomplishmentTypeRef.current) == null ? void 0 : _b.value;
                const link = ((_c = accomplishmentTypeRef.current) == null ? void 0 : _c.value) || "";
                const publisher = ((_d = accomplishmentTypeRef.current) == null ? void 0 : _d.value) || "";
                const id = ((_e = accomplishmentTypeRef.current) == null ? void 0 : _e.value) || "";
                const title = ((_f = accomplishmentTypeRef.current) == null ? void 0 : _f.value) || "";
                const certificate = ((_g = accomplishmentTypeRef.current) == null ? void 0 : _g.value) || "";
                if (name && type) {
                  setValue(
                    "accomplishments",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Errors, {}, void 0, false, {
        fileName: "app/routes/profile.education.tsx",
        lineNumber: 188,
        columnNumber: 15
      }, this),
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/profile.education-MNHDCLFD.js.map
